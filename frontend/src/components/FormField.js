        ...
        case "Keyword":
            return (
                <>
                    ...
                    <input id="keyword" name='keyword' ref={register()}></input> 
                </>    
            )
        case "Author":
            return (
                <>
                    ...
                    <input id="author" name='author' ref={register()}></input> 
                </>    
            )
        case "Color count":
            return (
                <>
                    <span className="tooltip">
                        <span className="tooltiptext">
                            Colors are counted on frame 1 of animations
                        </span>
                        Color count: 
                    </span>
                    Minimum: 
            ...
            return (
                <>
                    ...
                    <span className="onoff"> 
                        <input type="checkbox" name='transparency' id="transparency" ref={register()}></input>
        ...
        case "Tolerance":
            return (
                <>
                    <span className="tooltip">
                        <span className="tooltiptext">
                            Tolerance influences how accurate the colors of your query match the colors in the search result. 0 means exact match only, 20 means your r/g/b values +/- 20 for each of those values. Default is between 7 and 25 depending on the amount of colors in the query.
                        </span>
                        Color tolerance: 
                    </span>
                    <input name="tolerance" className="tolerance" type="range" min={0} max={40} step={1} ref={register()}></input>
                    <span id="range-value"> {watch('tolerance')}</span>
                </>    
            )
        default:
